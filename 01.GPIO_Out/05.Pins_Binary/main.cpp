...
int main(void)
{
  DDRB |= 0b00100000; // Defining 5th Pin of PORT B as output 0b00100000
  DDRB |= 0b00010000; // Defining 4th Pin of PORT B as output 0b00010000
  while(1) // A infinite loop unless returned 0
  {
    PORTB |= 0b00100000; //Setting 5th Pin of PORT B to HIGH - 0b00100000
    _delay_ms(1000); // Adding 1000ms second delay
    PORTB &=  0b00000000;   //Setting 5th Pin of PORT B to LOW -0b00000000
    _delay_ms(1000); // Adding 1000ms second delay
    PORTB |= 0b00010000; //Setting 4th Pin of PORT B to HIGH  - 0b00010000
    _delay_ms(1000); // Adding 1000ms second delay
    PORTB &=  0b00000000;   //Setting 4th Pin of PORT B to LOW  - 0b00000000
    _delay_ms(1000); // Adding 1000ms second delay
  }
}
